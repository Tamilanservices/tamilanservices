      ...
      <div class="modal-body p-4">
        <form class="needs-validation d-none signup" novalidate>
            ...
            <div class="mb-3 position-relative">
                ...
                <input type="tel" class="form-control pl-50" id="phone" name="phone" placeholder="Enter Your Mobile No" required>
            ...
            <div class="mb-3">
                ...
                <select class="selectpicker w-100" name="district" data-style="form-select border" id="district" data-live-search="true" required>
